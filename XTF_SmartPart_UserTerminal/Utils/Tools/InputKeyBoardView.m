...
@implementation InputKeyBoardView
{
    ...
    ClickChangeKeyBoard _clickChangeKeyBoard;
//    UIView *_toolView;      // 工具条视图
}

- (instancetype)initWithFrame:(CGRect)frame withClickKeyBoard:(ClickKeyBoard)clickKeyBoard withDelete:(ClickDelete)clickDelete withConfirm:(ClickConfirm)clickConfirm withChangeKeyBoard:(ClickChangeKeyBoard)clickChangeKeyBoard{
...
//        _data = data;
        ...
        _clickChangeKeyBoard = clickChangeKeyBoard;
