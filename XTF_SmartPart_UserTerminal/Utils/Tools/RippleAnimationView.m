...
- (CALayer *)pulsingLayer:(CGRect)rect animation:(CAAnimationGroup *)animationGroup {
    ...
    pulsingLayer.borderColor = ColorWithAlpha(203,20,39,1).CGColor;
...
- (CAKeyframeAnimation *)blackBorderColorAnimation {
    ...
    borderColorAnimation.keyPath = @"borderColor";
    borderColorAnimation.values = @[(__bridge id)ColorWithAlpha(203,20,39,0.4).CGColor,
                                    (__bridge id)ColorWithAlpha(203,20,39,0.4).CGColor,
                                    (__bridge id)ColorWithAlpha(203,20,39,0.1).CGColor,
                                    (__bridge id)ColorWithAlpha(203,20,39,0).CGColor];
    borderColorAnimation.keyTimes = @[@0.3,@0.6,@0.9,@1];
    return borderColorAnimation;
}
