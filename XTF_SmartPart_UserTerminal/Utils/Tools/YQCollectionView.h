...
@class YQCollectionView;

#pragma mark - YQDragCollectionViewDataSource

/**
 BMDragCollectionViewDataSource 协议
 BMDragCollectionViewDataSource protocol
 */
@protocol YQDragCollectionViewDataSource <UICollectionViewDataSource>
 ...
 */
- (nullable NSArray *)dataSourceWithDragCellCollectionView:(YQCollectionView *)dragCellCollectionView;

@end

#pragma mark - YQDragCellCollectionViewDelegate

/**
 DragCellCollectionViewDelegate 协议
 BMDragCellCollectionViewDelegate protocol
 */
@protocol YQDragCellCollectionViewDelegate <UICollectionViewDelegateFlowLayout>
...
/**
 ...
 @param dragCellCollectionView dragCellCollectionView
 */
- (void)dragCellCollectionViewDidEndDrag:(YQCollectionView *)dragCellCollectionView indexPath:(NSIndexPath *)indexPath;
...
/**
 ...
 @param indexPath 响应的indexPath，如果为 nil 说明没有接触到任何 Cell
 */
- (void)dragCellCollectionView:(YQCollectionView *)dragCellCollectionView changedDragAtPoint:(CGPoint)point indexPath:(NSIndexPath *)indexPath;
...
/**
 ...
 @param indexPath 响应的indexPath，如果为 nil 说明没有接触到任何 Cell
 */
- (void)dragCellCollectionView:(YQCollectionView *)dragCellCollectionView endedDragAtPoint:(CGPoint)point indexPath:(NSIndexPath *)indexPath;
 ...
 */
- (BOOL)dragCellCollectionView:(YQCollectionView *)dragCellCollectionView endedDragAutomaticOperationAtPoint:(CGPoint)point section:(NSInteger)section indexPath:(NSIndexPath *)indexPath;
...
/**
 ...
 @return dragView
 */
- (UIView *)dragCellCollectionView:(YQCollectionView *)dragCellCollectionView startDragAtIndexPath:(NSIndexPath *)indexPath;
...
/**
 ...
 @param indexPath indexPath
 */
- (void)dragCellCollectionView:(YQCollectionView *)dragCellCollectionView dragView:(UIView *)dragView indexPath:(NSIndexPath *)indexPath;

@end

#pragma mark - YQDragCellCollectionView

/**
 可以长按拖拽Cell的UICollectionView
 UICollectionView can grow by drag and drop the Cell
 */
@interface YQCollectionView : UICollectionView

@property (nonatomic, weak, nullable) id<YQDragCellCollectionViewDelegate> delegate; ///< 代理 delegate
@property (nonatomic, weak, nullable) id<YQDragCollectionViewDataSource> dataSource; ///< 数据源代理 dataSource
