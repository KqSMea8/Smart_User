...
@interface YQPlaceHolderTextView()<UITextViewDelegate>
...
@end
@implementation YQPlaceHolderTextView
...
-(void)addTextViewBeginEvent:(void (^)(YQPlaceHolderTextView *))begin{
    
    _BeginBlock=begin;
}

-(void)addTextViewEndEvent:(void (^)(YQPlaceHolderTextView *))End{
    _EndBlock=End;
}
...
-(void)textViewBeginNoti:(NSNotification*)noti{
    ...
    if (_BeginBlock) {
        void(^begin)(YQPlaceHolderTextView*text)=_BeginBlock;
        begin(self);
    }
}
-(void)textViewEndNoti:(NSNotification*)noti{
    ...
    if (_EndBlock) {
        void(^end)(YQPlaceHolderTextView*text)=_EndBlock;
        end(self);
    }
}
...
-(void)DidChange:(NSNotification*)noti{
    ...
    if (_eventBlock && self.text.length > self.maxTextLength) {
        ...
        void (^limint)(YQPlaceHolderTextView*text) =_eventBlock;
