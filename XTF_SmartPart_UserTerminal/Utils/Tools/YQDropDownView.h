...
#ifdef DEBUG
#define YQLogFlag YES
#else
#endif

@class YQDropDownView;
@class YQTopicContainerView;

@protocol YQDropDownDelegate <NSObject>
 ...
 *  @return 返回NSUInteger
 */
- (NSUInteger)numberOfRowsToDisplayIndropDown:(YQDropDownView *)dropDown itemArrayCount:(NSUInteger)count;
...
@interface YQDropDownView : UIView

@property (nonatomic, weak) id<YQDropDownDelegate> delegate;
