...
NSString *const kYQTabBarItemAttributeTitle = @"YQTabBarItemAttributeTitle";
NSString *const kYQTabBarItemAttributeNormalImageName = @"YQTabBarItemAttributeNormalImageName";
NSString *const kYQTabBarItemAttributeSelectedImageName = @"YQTabBarItemAttributeSelectedImageName";
NSString *const kYQTabBarItemAttributeType = @"YQTabBarItemAttributeType";
...
- (void)layoutSubviews {
    ...
    if (imageSize.width != 0 && imageSize.height != 0) {
        ...
        if (_tabBarItemType == YQTabBarItemRise) {
            imageViewCenterY = CGRectGetHeight(self.frame) - 3 - titleSize.height - imageSize.height / 2 - 10;
