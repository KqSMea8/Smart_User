...
@interface ParkOutViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    int _page;
    int _length;
...
@implementation ParkOutViewController
...
- (void)_loadRecordData {
    ...
    [params setObject:@"00" forKey:@"traceResult"];
