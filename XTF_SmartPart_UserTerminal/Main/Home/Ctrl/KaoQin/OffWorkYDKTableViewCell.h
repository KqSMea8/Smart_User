...
@protocol offWorkReSaveRecordDelegate <NSObject>

-(void)offWorkreSaveRecord:(NSString *)signType;

@end

@interface OffWorkYDKTableViewCell : UITableViewCell
...
@property (nonatomic,weak) id<offWorkReSaveRecordDelegate> delegate;
